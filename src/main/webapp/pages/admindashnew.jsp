...
<body>
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li>
				<a href="#">
					<span class="links_name">User Approved</span>
				</a>
			</li>
			...
			<li>
				<a href="#">
					<span class="links_name">User Rejected</span>
				</a>
			</li>
	...
	<section class="home-section">
		<nav>
			...
			<!-- <div class="search-box">
				...
				<i class='bx bx-search' style="background-color: orange; padding: 5px; border-radius: 4px;"></i>
			</div> -->
			<!-- <div class="profile-details">
				<img src="/photo/ldkb.png" alt="">
